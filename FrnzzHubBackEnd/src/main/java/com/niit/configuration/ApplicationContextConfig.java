...
public class ApplicationContextConfig {
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUsername("saleemah");
	    dataSource.setPassword("saleemah");
	    return dataSource;
	}
	@Autowired
	@Bean
...
@EnableWebMvc
@Configuration
@ComponentScan("com.niit.FrnzzHubBackEnd")
@EnableTransactionManagement
public class ApplicationContextConfig {
	@Bean(name = "dataSource")
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/Salproject2");
